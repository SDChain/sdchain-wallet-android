...
public final class RegisterEmailPresenter extends BasePresenter<RegisterEmailView> {

    public RegisterEmailPresenter(RegisterEmailView registerEmailView) {
        super(registerEmailView);
    }
     ...
     * get code
     */
    public void getCodeByEmail(String email, String mark,String randomPic, String validStr,Context context) {
        HashMap<String, String> map = new HashMap<String, String>();
        map.put("account", email);
        map.put("validStr", validStr);
        map.put("mark", mark);
        map.put("randomPic", randomPic);
        getDataWithUUID(API.EMAILCODE, map, true, new ResponseCallBack<CodeBean>(context) {
            @Override
    ...
    public void getImageCode(boolean isShow, Context context) {
        ...
        }, null, context.getString(R.string.info74), isShow, context);
    }
