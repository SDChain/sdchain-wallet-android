...
public final class RegisterEmail2Presenter extends BasePresenter<RegisterEmail2View> {

    public RegisterEmail2Presenter(RegisterEmail2View registerEmail2View) {
        super(registerEmail2View);
    }
     ...
     * email register
     */
    public void registByEmail(String email, String password, String smsId, String walletPassword, String validStr, Context context) {
