...
public final class BindPhoneFirstPresenter extends BasePresenter<BindPhoneFirstView> {

    public BindPhoneFirstPresenter(BindPhoneFirstView bindPhoneFirstView) {
        super(bindPhoneFirstView);
    }
    ...
    public void getCodeByPhone(String phone, String mark, String validStr, Context context) {
        ...
        }, null, context.getString(R.string.info91), false, context);
    }
    ...
    public void bindPhone(String smsId, String userId, String code, String phone, String password, String validStr, Context context) {
        ...
        }, null, context.getString(R.string.info92), true, context);
    }
}
