...
public final class SmoothCheckBox extends View implements Checkable {
    ...
    private void init(AttributeSet attrs) {
        ...
        TypedArray ta = getContext().obtainStyledAttributes(attrs, com.io.sdchain.R.styleable.SmoothCheckBox);
        int tickColor = ta.getColor(com.io.sdchain.R.styleable.SmoothCheckBox_color_tick, COLOR_TICK);
        mAnimDuration = ta.getInt(com.io.sdchain.R.styleable.SmoothCheckBox_duration, DEF_ANIM_DURATION);
        mFloorColor = ta.getColor(com.io.sdchain.R.styleable.SmoothCheckBox_color_unchecked_stroke, COLOR_FLOOR_UNCHECKED);
        mCheckedColor = ta.getColor(com.io.sdchain.R.styleable.SmoothCheckBox_color_checked, COLOR_CHECKED);
        mUnCheckedColor = ta.getColor(com.io.sdchain.R.styleable.SmoothCheckBox_color_unchecked, COLOR_UNCHECKED);
        mStrokeWidth = ta.getDimensionPixelSize(com.io.sdchain.R.styleable.SmoothCheckBox_stroke_width, Common.dip2px(getContext(), 0));
        ta.recycle();
    ...
    private int measureSize(int measureSpec) {
        int defSize = Common.dip2px(getContext(), DEF_DRAW_SIZE);
