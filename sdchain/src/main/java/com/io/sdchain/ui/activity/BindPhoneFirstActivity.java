...
import com.io.sdchain.mvp.presenter.BindPhoneFirstPresenter;
import com.io.sdchain.mvp.view.BindPhoneFirstView;
...
@Route(path = ARouterPath.BindPhoneFirstActivity)
public final class BindPhoneFirstActivity extends BaseActivity<BindPhoneFirstPresenter> implements BindPhoneFirstView {
    ...
    @Override
    protected BindPhoneFirstPresenter createPresenter() {
        return new BindPhoneFirstPresenter(this);
    }
    ...
    private void initView() {
        ...
        title.setText(getString(R.string.info104));
    ...
    public void onClickView(View view) {
        switch (view.getId()) {
                ...
                if (canClick) {
                    if (CheckFormat.isMobile(getEditString(phone))) {
                        if (getEditString(phone).equals(userBean.getPhone())) {
                            showToast(getString(R.string.info105));
                            return;
                        }
            ...
            case R.id.phoneBindBtn:
                ...
                if (codeInfo == null) {
                    showToast(getString(R.string.info106));
                    return;
                }
                if (!CheckFormat.isMobile(getEditString(phone))) {
                    showToast(getString(R.string.info107));
                    return;
                }
                if (getEditString(phone).equals(userBean.getPhone())) {
                    showToast(getString(R.string.info108));
                    return;
                }
    ...
    public void updateTimeOver() {
        ...
        timerDown.setText(getString(R.string.info109));
        canClick = true;
    }

    @Override
    public void onCodeSuccess(Object data, String msg) {
        showToast(getString(R.string.info110));
