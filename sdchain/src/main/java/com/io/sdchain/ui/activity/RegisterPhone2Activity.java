...
import com.io.sdchain.mvp.presenter.RegisterPhone2Presenter;
...
@Route(path = ARouterPath.RegisterPhone2Activity)
public final class RegisterPhone2Activity extends BaseActivity<RegisterPhone2Presenter> implements RegisterPhone2View {
    ...
    @Override
    protected RegisterPhone2Presenter createPresenter() {
        return new RegisterPhone2Presenter(this);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_register_phone2);
    ...
    @OnClick({R.id.deletePassword1, R.id.deletePassword2, R.id.phoneRegisterBtn, R.id.agreement})
    public void onClickView(View view) {
        switch (view.getId()) {
            ...
            case R.id.phoneRegisterBtn:
                ...
                break;
            case R.id.agreement:
                String country = LanguageUtils.getCountry(RegisterPhone2Activity.this);
                ARouter.getInstance()
    ...
    public void onSuccess(Object data, String msg) {
        ...
        EventBus.getDefault().post(new EventBusType(EventBusType.BusType.REGISTBYPHONE, "Registration was successful"));
        ARouter.getInstance().build(ARouterPath.CreateAccountActivity)
                .withString(ARouterPath.FROM, ARouterPath.RegisterPhone2Activity)
    ...
    public void passwordNotEmpty() {
        showToast(getString(R.string.info292));
    }

    @Override
    public void passwordNotComplex() {
        showToast(getString(R.string.info293));
    }

    @Override
    public void passwordNotSame() {
        showToast(getString(R.string.info294));
    }
    ...
    public void beginRegister() {
        ...
        if (codeBean == null) {
            showToast(getString(R.string.info295));
            return;
        }
        getPresenter().registByPhone(
                codeBean.getPhone(),
