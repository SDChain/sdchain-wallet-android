 ...
 */
public class DatePickerPopWin2 extends PopupWindow implements OnClickListener {
    ...
    public static class Builder{
        ...
        public DatePickerPopWin2 build(){
            if(minYear > maxYear){
                throw new IllegalArgumentException();
            }
            return new DatePickerPopWin2(this);
        }
    ...
    public DatePickerPopWin2(Builder builder){
    ...
    private void initView() {
        ...
        contentView = LayoutInflater.from(mContext).inflate(showDayMonthYear ? R.layout.layout_date_picker_inverted2 : R.layout.layout_date_picker2, null);
